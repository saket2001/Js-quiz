...
document.querySelector("#java").addEventListener("click", function () {
  game = "java";
  document.querySelector("#java").style.backgroundColor = "#f00000";
  ...
  document.querySelector("#cplus").style.backgroundColor = "yellow";
  document.querySelector("#cplus").style.color = "black";
  document.querySelector("#python").style.backgroundColor = "#yellow";
  document.querySelector("#python").style.color = "black";
  startTimer();
  Quiz(game);
});
document.querySelector("#c").addEventListener("click", function () {
  game = "c";
  document.querySelector("#java").style.backgroundColor = "yellow";
  document.querySelector("#java").style.color = "black";
  document.querySelector("#c").style.backgroundColor = "#f00000";
...
document.querySelector("#cplus").addEventListener("click", function () {
  ...
  document.querySelector("#c").style.backgroundColor = "yellow";
  document.querySelector("#c").style.color = "black";
  document.querySelector("#cplus").style.backgroundColor = "#f00000";
...
document.querySelector("#python").addEventListener("click", function () {
  ...
  document.querySelector("#cplus").style.backgroundColor = "#yellow";
  document.querySelector("#cplus").style.color = "black";
  document.querySelector("#python").style.backgroundColor = "#f00000";
